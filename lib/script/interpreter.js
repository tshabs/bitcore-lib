...
/**
 * Checks a sequence parameter with the transaction's nsequence.
 *
 * See the corresponding code on bitcoin core:
 * https://github.com/btcdrak/bitcoin/blob/c0c5e09fe2166a0b8ea6fc1f13e131e3ba8df478/src/script/interpreter.cpp#L376
 *
 * @param {BN} nLockTime the locktime read from the script
 * @return {boolean} true if the transaction's locktime is less than or equal to
 *                   the transaction's locktime
...
Interpreter.prototype.checkSequence = function(nSequence) {
  ...
  if (txToSequence & Transaction.SEQUENCE_LOCKTIME_DISABLE_FLAG) {
    return false;
  }

      // Mask off any bits that do not have consensus-enforced meanIng
      // before doing the integer comparisons
      let nLockTimeMask = Transaction.SEQUENCE_LOCKTIME_TYPE_FLAG | Transaction.SEQUENCE_LOCKTIME_MASK
